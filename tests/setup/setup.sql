...
CREATE OR REPLACE VIEW HOTEL.HIGHEST_PRICE AS ( -- view with a cte 
...
CREATE OR REPLACE VIEW HOTEL.FLAT_HOTEL_ROOMS AS --view with a star
...
CREATE OR REPLACE VIEW HOTEL.LATEST_MAINTENANCE AS -- view with 3 tables + window functions
  SELECT
  H.NAME,
  R.TYPE,
  R.PRICE,
...
CREATE OR REPLACE VIEW HOTEL.RANKED_ROOMS AS -- view with agg and rank function
  SELECT
  H.NAME,
  R.TYPE,
  R.PRICE,
...
CREATE OR REPLACE VIEW HOTEL.GUESTS AS --with subquery and window function, joined tables and view
  SELECT
    H.NAME,
    R.TYPE,
    R.PRICE,
...
CREATE OR REPLACE VIEW HOTEL.UNARY_ROOMS AS --with unary operator
